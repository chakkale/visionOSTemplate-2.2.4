...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.VisionOS
{
    ...
    public class SliderComponent : XRBaseInteractable
    {
        ...
        // Public property to access the value changed event
        public UnityEngine.Events.UnityEvent<float> OnSliderValueChanged => m_OnSliderValueChanged;
        // Public property to access the initial slider percent
        public float InitialSliderPercent => m_InitialSliderPercent;
